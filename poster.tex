...
\begin{columns}
  \column{0.5}
  \block{Introduction}{
    Chirality is central to chemistry and biochemistry and drug design~\cite{Chergui2016}.
  ...
  \end{align}
    ...
    \centering
    \includegraphics[width=\linewidth]{figures/pipeline_gs.png}
    \captionof{figure}{Pipeline for the computation of ground-state XAS and XNCD in molecules.}
    \label{fig:pipeline_gs}
    \centering
    \includegraphics[width=\linewidth]{figures/pipeline_es.png}
    \captionof{figure}{Pipeline for the computation of excited-state XAS and XNCD in molecules.}
    \label{fig:pipeline_es}  
  }

  \block{Acknowledgements}{
    Funding was provided by the European Research Council (ERC) through the CHIRAX project. Computational and institutional support from the University of Trieste and Elettra Sincrotrone Trieste is gratefully acknowledged.
  }
  ...
  \block{Results and Discussion}{
    ...
    \begin{minipage}[t]{0.71\linewidth}
      ...
      \captionof{figure}{Experimental vs.\ computed ground-state XAS and XNCD for \textbf{C K-edge} of (R)-methyloxirane. Coupled-Cluster data was obtained from Andersen \textit{et al.}~\cite{Andersen2022}, while experimental data was obtained from \cite{piancastelli2007,turchini2004}. A rigid shift of 10.6~eV was applied to WaveT results to align with experiment.}
  ...
  \block{Conclusions}{
    \begin{itemize}
      ...
      \item Ongoing work for including solvent effects (PMM \cite{Amadei2009} and COSMO).
    \end{itemize}
  }
